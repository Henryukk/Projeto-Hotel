...
public class TelaBuscaFornecedor extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBoxFiltrarPor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "NOME", "CPF", "RAZAO SOCIAL", "CNPJ", "STATUS" }));
        ...
        jTableColunas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "CPF", "Razão Social", "CNPJ", "Status"
            }
        ));
        jScrollPane1.setViewportView(jTableColunas);
        if (jTableColunas.getColumnModel().getColumnCount() > 0) {
            jTableColunas.getColumnModel().getColumn(0).setResizable(false);
        }
